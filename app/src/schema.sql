...
VALUES
  ...
  ('tech.ai_infra_private_capital', 'tech', 'tech.infrastructure', 'AI Infrastructure Private Capital', 'Infra Capital', 'AI Infrastructure Private Capital',
   'Private-capital financing of AI infrastructure: venture rounds, growth equity, Series C/D/E raises for inference providers, model-serving startups, private valuation marks, unicorn crossings, order-book-backed raises, inference-ASIC challenger funding, standalone datacenter funding vehicles, sovereign-AI national champion vehicles, defense-AI institutional mega-rounds, equity-coupled supply allocation, depositary-receipt proceeds converted to booked equipment orders, warrant-linked stakes, self-financed multi-decade power agreements, confidential S-1 steps, secondary marks on privately held AI infrastructure, Baseten, Etched, Tenstorrent, SK hynix capital raises.', 'active');
...
UPDATE themes SET
  label_ja = 'AIインフラ民間資本', short_label_ja = 'インフラ資本',
  label_es = 'Capital Privado de Infraestructura IA', short_label_es = 'Capital Infra',
  label_fil = 'Pribadong Kapital sa AI Infrastructure', short_label_fil = 'Kapital Infra',
  description = 'Private-capital financing of AI infrastructure: venture rounds, growth equity, Series C/D/E raises for inference providers, model-serving startups, private valuation marks, unicorn crossings, order-book-backed raises, inference-ASIC challenger funding, standalone datacenter funding vehicles, sovereign-AI national champion vehicles, defense-AI institutional mega-rounds, equity-coupled supply allocation, depositary-receipt proceeds converted to booked equipment orders, warrant-linked stakes, self-financed multi-decade power agreements, confidential S-1 steps, secondary marks on privately held AI infrastructure, Baseten, Etched, Tenstorrent, SK hynix capital raises.',
  description_ja = 'AIインフラの民間資本による資金調達: ベンチャーラウンド、グロースエクイティ、推論プロバイダーおよびモデルサービング企業向けシリーズC/D/E調達、未公開バリュエーション評価、ユニコーン到達、受注残高を裏付けとした調達、inference-ASIC 挑戦者への出資、独立系データセンター資金ビークル、ソブリンAIナショナルチャンピオン向けビークル、防衛AIの機関投資家メガラウンド、エクイティ連動の供給枠、預託証券調達資金の装置発注への転換、ワラント連動の出資、自己資金による超長期の電力契約、秘密提出のS-1ステップ、未公開AIインフラのセカンダリー評価、Baseten、Etched、Tenstorrent、SK hynix の資本調達。',
  description_es = 'Financiación con capital privado de infraestructura de IA: rondas de venture, growth equity, rondas Series C/D/E para proveedores de inferencia y empresas de model-serving, marcas de valoración privada, cruces de unicornio, rondas respaldadas por cartera de pedidos, financiación de challengers de inference-ASIC, vehículos independientes de financiación de datacenter, vehículos de campeones nacionales de IA soberana, mega-rondas institucionales de IA de defensa, asignación de suministro acoplada a participación, conversión de fondos de certificados de depósito en pedidos de equipo, participaciones ligadas a warrants, acuerdos de energía autofinanciados a varias décadas, pasos de S-1 confidencial, marcas secundarias sobre infraestructura de IA privada, Baseten, Etched, Tenstorrent, SK hynix.',
  description_fil = 'Pagpopondo ng pribadong kapital sa AI infrastructure: mga venture round, growth equity, mga Series C/D/E raise para sa mga inference provider at model-serving startup, mga pribadong valuation mark, pag-abot ng unicorn, mga raise na nakasandal sa order book, pagpopondo sa mga inference-ASIC challenger, mga standalone na datacenter funding vehicle, mga vehicle ng sovereign-AI national champion, mga institutional mega-round sa defense-AI, equity-coupled na supply allocation, pagkonberte ng depositary-receipt proceeds tungo sa nakabook na equipment order, mga warrant-linked na stake, mga self-financed na multi-dekadang power agreement, mga confidential na hakbang sa S-1, mga secondary mark sa pribadong AI infrastructure, Baseten, Etched, Tenstorrent, SK hynix.'
WHERE theme_id = 'tech.ai_infra_private_capital';
